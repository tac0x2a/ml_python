...
print(iris_dataset['target_names']) # ラベル名

print(iris_dataset['feature_names']) # 特徴量名

iris_dataset['data'].shape
iris_dataset['data'][:5] # 最初の5サンプル
...
X_train.shape # (112,4): 75%
X_test.shape # (38,4): 25%
y_train.shape
y_test.shape
...
knn = KNeighborsClassifier(n_neighbors=1) # n_neighbors:近傍点の数

knn.fit(X_train, y_train) # 訓練セットを使ってモデル構築する
...
np.mean(y_pred == y_test) # True(正解)の割合を計算する
